...
const AddCommandeFrom = () => {
  const navigate = useNavigate();
  const [commande, setUsers] = useState([]);
            ...
            <div className="content-wrapper">
              ...
              <div className="container-xxl flex-grow-1 container-p-y">
                <h4 className="fw-bold py-3 mb-4">
                  <span className="text-muted fw-light">Commandes /</span>  Ajouter une commande 
                </h4>
...
export default AddCommandeFrom;
